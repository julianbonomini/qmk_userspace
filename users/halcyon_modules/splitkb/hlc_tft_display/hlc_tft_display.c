...
static const char *alt_text =    "Alt";
static const char *gui_text =    "Cmd";
...
void update_display(void) {
    ...
    if(last_mods != mods || first_run_mods == false) {
        bool ctrl_active = mods & MOD_MASK_CTRL;
        bool alt_active = mods & MOD_MASK_ALT;
        bool gui_active = mods & MOD_MASK_GUI;

        ctrl_active ? qp_drawtext_recolor(lcd_surface, 5, LCD_HEIGHT - Retron27->line_height * 3 - 15, Retron27_underline, ctrl_text, HSV_CAPS_ON, HSV_BLACK) : qp_drawtext_recolor(lcd_surface, 5, LCD_HEIGHT - Retron27->line_height * 3 - 15, Retron27, ctrl_text, HSV_CAPS_OFF, HSV_BLACK);
        alt_active  ? qp_drawtext_recolor(lcd_surface, 5, LCD_HEIGHT - Retron27->line_height * 2 - 10, Retron27_underline, alt_text,  HSV_NUM_ON,  HSV_BLACK) : qp_drawtext_recolor(lcd_surface, 5, LCD_HEIGHT - Retron27->line_height * 2 - 10, Retron27, alt_text,  HSV_NUM_OFF,  HSV_BLACK);
        gui_active  ? qp_drawtext_recolor(lcd_surface, 5, LCD_HEIGHT - Retron27->line_height - 5,      Retron27_underline, gui_text,  HSV_SCROLL_ON, HSV_BLACK) : qp_drawtext_recolor(lcd_surface, 5, LCD_HEIGHT - Retron27->line_height - 5,      Retron27, gui_text,  HSV_SCROLL_OFF, HSV_BLACK);
